...
def parameter_parser():
    ...
    parser.add_argument("--dataset",
                        nargs = "?",
                        default = "../data/AIDS700nef/",
	                help = "Folder of dataset, including training and testing graphs.")

    parser.add_argument("--training_graphs",
                        nargs = "?",
                        default = "../data/AIDS700nef/train/",
	                help = "Folder with training graph pair jsons.")

    parser.add_argument("--testing_graphs",
                        nargs = "?",
                        default = "../data/AIDS700nef/test/",
